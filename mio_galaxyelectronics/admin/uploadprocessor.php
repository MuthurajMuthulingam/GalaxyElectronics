...
$uploadForm = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'addProductToSubCatagory.php'; 

// make a note of the location of the success page
$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'addProductToSubCatagory.php';
if(isset($_REQUEST['location']))
    $uploadSuccess=$_REQUEST['location'];
