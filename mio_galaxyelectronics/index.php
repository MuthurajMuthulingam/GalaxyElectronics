...
//echo json_encode($offerProductlist);
?>
             ...
             for ($i = 0; $i < count($offerproductArray); $i++) {
                echo '<div class="slide">
                        ...
                        <div class="featured_image">
                                                        <a href="productDescription.php?opid="'.$offerproductArray[$i]['pid'].' ><img src="admin/uploaded_images/' . $offerproductArray[$i]['pimage'] . '" width="250" height="250" alt="'.$offerproductArray[$i]['pname'].'" /></a>
                                                </div><!--close featured_image-->
                        
                        <div class="product_meta">
                            <div class="price">
                                <p><span class="amount">Rs ' . $offerproductArray[$i]['pprice'] . '</span></p>
